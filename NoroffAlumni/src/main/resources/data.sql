...
INSERT INTO users(id,title,username,email,first_name,last_name,biography,funfact, profile_theme) VALUES ('48cec1a0-ffd8-465b-97f1-b6cbcd07ab8d','Fullstack developer','oliviamiller','olivia.miller@example.com','Olivia','Miller','Just a girl trying to make her way in the world, one day at a time.','Olivia is fluent in four languages.', '1');
INSERT INTO users(id,title,username,email,first_name,last_name,biography,funfact, profile_theme) VALUES ('6b51d04c-f880-4ac9-93b5-bc53e81bc50b','CEO at Ava-tech','ethanlee96','ethan.lee@example.com','Ethan','Lee','Aspiring entrepreneur with a passion for innovation and problem-solving.','Ethan once ran a marathon on a whim, without any prior training.','2');
INSERT INTO users(id,title,username,email,first_name,last_name,biography,funfact, profile_theme) VALUES ('73a0dc81-2416-469c-9f75-e13d75bd5f34','Freelance journalist','avapatel22','ava.patel@example.com','Ava','Patel','Lover of animals and nature, striving to make the world a better place for all.','Ava once saved a baby bird and nursed it back to health.','3');
INSERT INTO users(id,title,username,email,first_name,last_name,biography,funfact, profile_theme) VALUES ('1aa307ac-5018-4e91-926e-8496617d2d54','Aspiring artist','jacksonkim123','jackson.kim@example.com','Jackson','Kim','Always looking for the next adventure, whether it''s traveling to a new country or trying a new sport.','Jackson has a black belt in taekwondo.','4');
INSERT INTO users(id,title,username,email,first_name,last_name,biography,funfact, profile_theme) VALUES ('28250440-c5d2-453e-a0c2-31c150277e92','UOA, Undergraduate','chloewong88','chloe.wong@example.com','Chloe','Wong','Creative soul with a passion for art and music, constantly seeking inspiration from the world around her.','Chloe once painted a mural on the side of a building in her hometown.','2');
