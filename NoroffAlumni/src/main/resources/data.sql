...
INSERT INTO users(id,title,username,email,first_name,last_name,biography,funfact) VALUES ('73a0dc81-2416-469c-9f75-e13d75bd5f34','Ms.','avapatel22','ava.patel@example.com','Ava','Patel','Lover of animals and nature, striving to make the world a better place for all.','Ava once saved a baby bird and nursed it back to health.');
INSERT INTO users(id,title,username,email,first_name,last_name,biography,funfact) VALUES ('1aa307ac-5018-4e91-926e-8496617d2d54','Mr.','jacksonkim123','jackson.kim@example.com','Jackson','Kim','Always looking for the next adventure, whether it''s traveling to a new country or trying a new sport.','Jackson has a black belt in taekwondo.');
